...
class StorageServiceTest {
    ...
    shouldStoreImageWhenProvided() {
        service.store(image, description);
    ...
    public void shouldNotStoreImageWhenGivenImageHasNoContent() {
        assertThrows(EmptyFileException.class, () -> service.store(imageWithNoContent, description));
    }

    @Test
    public void shouldNotStoreImageWhenGivenImageHasAbsolutePath() {
        assertThrows(StorageException.class, () -> service.store(imageWithAbsolutePath, description));
    }
